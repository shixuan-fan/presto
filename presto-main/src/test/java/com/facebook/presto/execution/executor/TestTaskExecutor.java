...
public class TestTaskExecutor
{
    ...
    public void testQuantaFairness()
    {
        ...
        try {
            TaskHandle shortQuantaTaskHandle = taskExecutor.addTask(new TaskId("short_quanta", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.empty());
            TaskHandle longQuantaTaskHandle = taskExecutor.addTask(new TaskId("long_quanta", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.empty());
    ...
    public void testLevelMovement()
    {
        ...
        try {
            TaskHandle testTaskHandle = taskExecutor.addTask(new TaskId("test", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.empty());
        ...
        try {
            for (int i = 0; i < (LEVEL_THRESHOLD_SECONDS.length - 1); i++) {
                TaskHandle[] taskHandles = {
                        taskExecutor.addTask(new TaskId("test1", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.empty()),
                        taskExecutor.addTask(new TaskId("test2", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.empty()),
                        taskExecutor.addTask(new TaskId("test3", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.empty())
                };
    ...
    public void testLevelContributionCap()
    {
        ...
        TaskHandle handle0 = new TaskHandle(new TaskId("test0", 0, 0, 0), new TaskPriorityTracker(splitQueue), () -> 1, 1, new Duration(1, SECONDS), OptionalInt.empty(), SessionLogger.NOOP);
        TaskHandle handle1 = new TaskHandle(new TaskId("test1", 0, 0, 0), new TaskPriorityTracker(splitQueue), () -> 1, 1, new Duration(1, SECONDS), OptionalInt.empty(), SessionLogger.NOOP);
    ...
    public void testUserSpecifiedMaxDriversPerTask()
    {
        ...
        try {
            ...
            TaskHandle testTaskHandle = taskExecutor.addTask(new TaskId("test", 0, 0, 0), () -> 0, 10, new Duration(1, MILLISECONDS), SessionLogger.NOOP, OptionalInt.of(1));
