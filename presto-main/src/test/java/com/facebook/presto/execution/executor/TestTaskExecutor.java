...
public class TestTaskExecutor
{
    ...
    public void testLevelContributionCap()
    {
        ...
        TaskHandle handle0 = new TaskHandle(new TaskId("test0", 0, 0, 0), splitQueue, () -> 1, 1, new Duration(1, SECONDS), OptionalInt.empty(), SessionLogger.NOOP);
        TaskHandle handle1 = new TaskHandle(new TaskId("test1", 0, 0, 0), splitQueue, () -> 1, 1, new Duration(1, SECONDS), OptionalInt.empty(), SessionLogger.NOOP);
