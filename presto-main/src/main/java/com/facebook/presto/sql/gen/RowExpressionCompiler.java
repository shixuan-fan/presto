        ...
        public BytecodeNode visitCall(CallExpression call, Context context)
        {
            ...
            switch (functionMetadata.getImplementationType()) {
                ...
                case SQL:
                    ...
                    RowExpression function = getSqlFunctionRowExpression(functionMetadata, functionImplementation, metadata, sqlFunctionProperties, call.getArguments(), legacyTypeCoercionWarningEnabled);

                    // Pre-compile lambda bytecode and update compiled lambda map
                    compiledLambdaMap.putAll(generateMethodsForLambda(classDefinition, callSiteBinder, cachedInstanceBinder, function, metadata, sqlFunctionProperties, "sql", compiledLambdaMap.keySet(), legacyTypeCoercionWarningEnabled));

                    // generate bytecode for SQL function
                    RowExpressionCompiler newRowExpressionCompiler = new RowExpressionCompiler(classDefinition, callSiteBinder, cachedInstanceBinder, fieldReferenceCompiler, metadata, sqlFunctionProperties, compiledLambdaMap, legacyTypeCoercionWarningEnabled);
